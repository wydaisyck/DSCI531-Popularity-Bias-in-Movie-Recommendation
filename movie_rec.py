...
from group_function import get_user_hist_pop_item


def mp(number_of_process):
    process = []
    for i in range(number_of_process):
        process.append(multiprocessing.Process(target=get_user_hist_pop_item(),
...
dict_graph = {"low_gap_vals": low_gap_vals,
              "medium_gap_vals": medium_gap_vals,
              "high_gap_vals": high_gap_vals}
with open("dict_graph.json", 'w') as f:
